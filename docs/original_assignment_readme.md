...
Historical assignment-style landing page, retained for provenance. The task list
and grading matrix below are not evidence that every scenario was implemented.
